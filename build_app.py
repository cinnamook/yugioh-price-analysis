...
@media(min-width:901px){.btoolbar{left:50%;right:auto;transform:translateX(-50%);width:min(1000px,calc(100% - 44px))}}
.btoolbar .btsel{width:100%;font-size:13px}
...
/* Opt-in only: reached from the "Declare" button while a card is selected. It used to
   prompt automatically after every placement, which got in the way far more than it helped. */

...
function sideInfoHTML(){ return '<div class="bsidepanel bsideleft">'+sideInfoBody(hoverIt||selInst(),!!hoverIt)+'</div>'; }
...
function sidePileHTML(){
  ...
  if(!k||!OPEN_PILES[k])return '<div class="bsidepanel bsideright"></div>';
  var a=board[k]||[];
